...
/* Redefinition of the Ethernet driver buffers size and count */   
 ...
 #define ETH_TXBUFNB        20                  /* 5  Tx buffers of size ETH_TX_BUF_SIZE */
#endif
...
#define PHY_SR    ((uint16_t)0x1E) /* Value for KSZ8081RN PHY */
...
#define PHY_SPEED_STATUS            ((uint16_t)0x0001) /* Value for KSZ8081RN PHY */
#define PHY_DUPLEX_STATUS           ((uint16_t)0x0004) /* Value for KSZ8081RN PHY */
